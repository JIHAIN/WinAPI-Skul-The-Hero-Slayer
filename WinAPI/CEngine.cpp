...
void CEngine::Render()
{
	...
	// GetCurrentDirectory 테스트 파일경로 알아옴
	//wchar_t CurDir[256] = {};
	//GetCurrentDirectory(256, CurDir);
	//TextOut(m_BackBuffer->GetDC(), 10, 10, CurDir, wcslen(CurDir));
...
void CEngine::CreateGDIObject()
{
	...
	m_Brush[(int)BRUSH_TYPE::SKYBLUE] = CreateSolidBrush(RGB(57, 215, 257));
